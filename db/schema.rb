...
ActiveRecord::Schema[7.0].define(version: 3022_05_03_170543) do
  ...
  create_table "active_storage_blobs", charset: "utf8mb4", collation: "utf8mb4_spanish_ci", force: :cascade do |t|
  ...
  create_table "active_storage_variant_records", charset: "utf8mb4", collation: "utf8mb4_spanish_ci", force: :cascade do |t|
    t.bigint "blob_id", null: false
    t.string "variation_digest", null: false
    t.index ["blob_id", "variation_digest"], name: "index_active_storage_variant_records_uniqueness", unique: true
  end

  create_table "cargos", charset: "utf8mb4", collation: "utf8mb4_spanish_ci", force: :cascade do |t|
    t.string "nombre"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "cotizacions", charset: "utf8mb4", collation: "utf8mb4_spanish_ci", force: :cascade do |t|
  ...
  create_table "divisions", charset: "utf8mb4", collation: "utf8mb4_spanish_ci", force: :cascade do |t|
  ...
  create_table "evaluacions", charset: "utf8mb4", collation: "utf8mb4_spanish_ci", force: :cascade do |t|
    t.bigint "proveedor_id", null: false
    t.string "pregunta"
  ...
  create_table "linea_cotizacions", charset: "utf8mb4", collation: "utf8mb4_spanish_ci", force: :cascade do |t|
  ...
  create_table "linea_requesicions", charset: "utf8mb4", collation: "utf8mb4_spanish_ci", force: :cascade do |t|
  ...
  create_table "proveedors", charset: "utf8mb4", collation: "utf8mb4_spanish_ci", force: :cascade do |t|
  ...
  create_table "references", charset: "utf8mb4", collation: "utf8mb4_spanish_ci", force: :cascade do |t|
    t.bigint "proveedor_id", null: false
  ...
  create_table "requesicions", charset: "utf8mb4", collation: "utf8mb4_spanish_ci", force: :cascade do |t|
    t.bigint "usuario_id", null: false
  ...
  create_table "tipo_productos", charset: "utf8mb4", collation: "utf8mb4_spanish_ci", force: :cascade do |t|
    t.string "nombre"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "ubicacions", charset: "utf8mb4", collation: "utf8mb4_spanish_ci", force: :cascade do |t|
    t.string "nombre"
    t.string "direccion"
    t.bigint "proveedor_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "usuarios", charset: "utf8mb4", collation: "utf8mb4_spanish_ci", force: :cascade do |t|
    t.string "nombre"
    t.string "apellido"
    t.integer "edad"
    t.string "dui"
  ...
  create_table "views", charset: "utf8mb4", collation: "utf8mb4_spanish_ci", force: :cascade do |t|
    t.string "email", default: "", null: false
    t.string "encrypted_password", default: "", null: false
    t.string "reset_password_token"
    t.datetime "reset_password_sent_at"
