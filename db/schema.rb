...
ActiveRecord::Schema[7.0].define(version: 2022_05_29_204335) do
  create_table "active_storage_attachments", charset: "armscii8", collation: "armscii8_bin", force: :cascade do |t|
  ...
  create_table "active_storage_blobs", charset: "armscii8", collation: "armscii8_bin", force: :cascade do |t|
  ...
  create_table "active_storage_variant_records", charset: "armscii8", collation: "armscii8_bin", force: :cascade do |t|
    t.bigint "blob_id", null: false
  ...
  create_table "ubicacions", charset: "armscii8", collation: "armscii8_bin", force: :cascade do |t|
    t.string "nombre"
    t.string "direccion"
    t.bigint "proveedor_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "views", charset: "armscii8", collation: "armscii8_bin", force: :cascade do |t|
    t.string "email", default: "", null: false
    t.string "encrypted_password", default: "", null: false
    t.string "reset_password_token"
    t.datetime "reset_password_sent_at"
